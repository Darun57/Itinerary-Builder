...
export function RevenuePipelineChart({
  ...
  const { ceiling, ticks } = useMemo(() => {
    ...
    if (maxAmount <= 0) {
      return {
        ceiling: 200000,
        ticks: [200000, 150000, 100000, 50000, 0],
      };
    }
    const targetTicks = 4;
  ...
  // Compute headline total (in full rupees)
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
            ...
            >
              {period === "monthly" ? "YTD" : "Last 7 Days"}
            </span>
          </div>
        </div>

        {/* Right Actions: Badge + Period Toggle */}
          ...
          >
            <button
              ...
              style={{
                ...
                background:
                  period === "monthly"
                    ? "linear-gradient(135deg, #C9A84C, #9A7B30)"
                    : "transparent",
      ...
      <div style={{ position: "relative", width: "100%", height: "220px" }}>
        ...
        >
          <defs>
            {/* Soft gold gradient fill */}
            <linearGradient id="goldAreaGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#E5B242" stopOpacity="0.32" />
              <stop offset="65%" stopColor="#E5B242" stopOpacity="0.08" />
              <stop offset="100%" stopColor="#E5B242" stopOpacity="0.0" />
            </linearGradient>

            {/* Glowing gold drop shadow for line */}
            <filter id="goldLineGlow" x="-10%" y="-20%" width="120%" height="150%">
              <feDropShadow
                dx="0"
                dy="3"
                stdDeviation="5"
        ...
        {hoveredIdx !== null && points[hoveredIdx] && (
          ...
          >
            ...
            <div style={{ fontSize: "13px", fontWeight: 700, color: "#9A7B30" }}>
