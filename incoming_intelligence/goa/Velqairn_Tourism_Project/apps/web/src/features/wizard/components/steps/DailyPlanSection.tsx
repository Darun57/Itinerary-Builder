  ...
  return (
    <div className="space-y-6 pt-6 border-t border-border mt-8 animate-in fade-in duration-500">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Select recommended Goa regions, locations, and activities for each day.</p>
      </div>
            ...
            <div key={field.id} className="p-4 rounded-lg border border-border bg-card/50 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>River / Boat Transfer</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Transfer Timings</FormLabel>
                      <FormControl>
                        <Input 
