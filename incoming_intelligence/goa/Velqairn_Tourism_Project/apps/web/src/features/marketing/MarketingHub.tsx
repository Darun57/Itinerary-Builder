...
const INITIAL_CAMPAIGNS: Campaign[] = [
  {
    ...
    package: "5D/4N North Goa & South Goa Luxury Escape",
    channel: "all",
    status: "active",
    reach: 14200,
    leads: 32,
  ...
  },
  {
    ...
    package: "6D/5N Panaji & North Goa Romance Tour",
    channel: "whatsapp",
    status: "active",
    reach: 8900,
    leads: 24,
...
const PROMO_PACKAGES = [
  {
    id: "pkg-1",
    name: "Luxury North Goa & South Goa Odyssey",
...
export function MarketingHub() {
  ...
  const handleCreateCampaign = (e: React.FormEvent) => {
    ...
    const newCamp: Campaign = {
      id: `camp-${Date.now()}`,
      title: newTitle.trim(),
      package: newPackage.trim() || "Goa Bespoke Tour",
      channel: newChannel,
      status: "active",
      reach: 0,
      leads: 0,
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "28px", flexWrap: "wrap", gap: "16px" }}>
        <div>
          ...
          <p style={{ color: "var(--text-dim)", fontSize: "13.5px", margin: 0 }}>
            Launch luxury Goa promotions, broadcast WhatsApp offers to leads, and drive new high-value bookings.
          </p>
        </div>
            ...
            <form onSubmit={handleCreateCampaign}>
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Goa Island Romance Blast"
                  value={newTitle}
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  type="text"
                  placeholder="e.g. 5D/4N North Goa & South Goa Luxury Escape"
                  value={newPackage}
