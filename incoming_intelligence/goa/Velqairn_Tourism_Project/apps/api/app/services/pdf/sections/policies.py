...
def render_things_to_do_page(story: list, styles: dict[str, ParagraphStyle]) -> None:
    _render_policy_page_title(story, styles, "THINGS TO DO IN GOA", "Signature Goa experiences curated for an elevated journey.")
...
def render_payment_policy_page(story: list, styles: dict[str, ParagraphStyle], request: TripRequest = None) -> None:
    ...
    preamble_text = (
        ...
        f"by and between <b>Goa Darun Tours and Travels</b>, a duly licensed travel agency with its principal "
        f"office located at <b>Goa, India</b> (\"Agency\"), and <b>{client_name}</b>, "
    ...
    story.append(Paragraph("• <b>Voucher &amp; Ticket Release:</b> Official hotel confirmation vouchers, river, boat, or ferry confirmations, and activity permits are issued following settlement of payments.", s_bullet))
...
def render_cancellation_policy_page(story: list, styles: dict[str, ParagraphStyle], request: TripRequest = None) -> None:
    ...
    story.append(Paragraph("• <b>Carrier &amp; Ferry Policies:</b> Flights and river and boat services (Mandovi River Cruise, Mandovi River Cruise, Goa River Ferry) follow the respective carrier cancellation and refund rules.", s_bullet))
...
def render_terms_conditions_pages(story: list, styles: dict[str, ParagraphStyle], request: TripRequest = None) -> None:
    ...
    story.append(Paragraph("• <b>Ferry &amp; Sea Movements:</b> River, boat, and ferry operations remain subject to weather, operating conditions, and local authority directives. Schedules may be altered in the interest of passenger safety.", s_bullet))
...
def render_payment_details_page(story: list, styles: dict[str, ParagraphStyle]) -> None:
    ...
    left_content = [
        ...
        Paragraph(escape_text("GOA DARUN TOURS AND TRAVELS"), styles["body"]),
        Spacer(1, 0.06 * inch),
    ...
    for text, style_name in [
        ...
        ("Hemawathi", "day_title"),
        ("Proprietor", "label"),
        ("Goa Darun Tour and Travels", "body"),
        ("Phone", "label"),
        ("+91 9474238991", "body"),
        ("+91 9933242718", "body"),
    ]:
...
def render_invoice_page(story: list, styles: dict[str, ParagraphStyle], request: TripRequest) -> None:
    ...
    destination       = str(request.destination or "Goa").strip()
    ...
    right_header = [
        Paragraph("GOA DARUN TOURS AND TRAVELS", s_co_name),
        Spacer(1, 4),
        Paragraph("Goa, India", s_co_info),
